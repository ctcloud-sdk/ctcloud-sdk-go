...
<h1 align="center">CT Cloud Go Software Development Kit (Go SDK)</h1>

The CT Cloud Go SDK allows you to easily work with CT Cloud services such as Elastic Compute Service (ECS) and
Virtual Private Cloud (VPC) without the need to handle API related tasks.

This document introduces how to obtain and use CT Cloud Go SDK.

## Requirements

- To use CT Cloud Go SDK, you must have CT Cloud account as well as the Access Key (AK) and Secret key (SK) of the CT
  Cloud account. You can create an AccessKey in the CT Cloud console.

- To use CT Cloud Go SDK to access the APIs of specific service, please make sure you do have activated the service
  in [CT Cloud console](https://console.hc.sbercloud.ru/) if needed.

- CT Cloud Go SDK requires go 1.14 or later, run command `go version` to check the version of Go.

## Install Go SDK

Run the following command to install CT Cloud Go SDK:

``` bash
# Install the library of CT Cloud Go SDK
go get github.com/ctcloud-sdk/ctcloud-sdk-go
```

## Code Example

- The following example shows how to query a list of VPCs in a specific region, you need to substitute your
  real `{service} "github.com/ctcloud-sdk/ctcloud-sdk-go/services/{service}/{version}"`
  for `vpc "github.com/ctcloud-sdk/ctcloud-sdk-go/services/vpc/v2"` in actual use, and initialize the client
...
import (
    ...
    "github.com/ctcloud-sdk/ctcloud-sdk-go/core/config"
    "github.com/ctcloud-sdk/ctcloud-sdk-go/core/httphandler"
    vpc "github.com/ctcloud-sdk/ctcloud-sdk-go/services/vpc/v2"
    "github.com/ctcloud-sdk/ctcloud-sdk-go/services/vpc/v2/model"
    "net/http"
)
...
the [CHANGELOG.md](https://github.com/ctcloud-sdk/ctcloud-sdk-go/blob/master/CHANGELOG.md).

## User Manual [:top:](#ct-cloud-go-software-development-kit-go-sdk)
...
``` go
import "github.com/ctcloud-sdk/ctcloud-sdk-go/core/config"
...
import (
	...
	"github.com/ctcloud-sdk/ctcloud-sdk-go/core/auth/basic"
	"github.com/ctcloud-sdk/ctcloud-sdk-go/core/def"

	service "github.com/ctcloud-sdk/ctcloud-sdk-go/services/service/v1"
	"github.com/ctcloud-sdk/ctcloud-sdk-go/services/service/v1/model"
)
