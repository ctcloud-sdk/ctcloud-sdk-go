...
const (
	akEnvName            = "CTCLOUD_SDK_AK"
	skEnvName            = "CTCLOUD_SDK_SK"
	projectIdEnvName     = "CTCLOUD_SDK_PROJECT_ID"
	domainIdEnvName      = "CTCLOUD_SDK_DOMAIN_ID"
	securityTokenEnvName = "CTCLOUD_SDK_SECURITY_TOKEN"
	idpIdEnvName         = "CTCLOUD_SDK_IDP_ID"
	idTokenFileEnvName   = "CTCLOUD_SDK_ID_TOKEN_FILE"
)
